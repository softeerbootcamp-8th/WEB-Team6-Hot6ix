...
인스타그램 라이브, 카카오톡 오픈채팅, X(트위터), 디스코드 등 이미 많은 사람들이 이런 SNS
...
- **소통** — 데일리 스크럼(오전 10시·오후 6시), 정기 회의(월·화·목 오후 2시),
  매주 금요일 KPT 회고
...
| 주차 | 기간 | 목표 |
|---|---|---|
| 1주차 | 07.20 ~ 07.26 | 기획 확정, API 명세서·기능 명세서·ERD 작성 |
| 2주차 | 07.27 ~ 08.02 | 최소 E2E 흐름 연결 |
| 3주차 | 08.03 ~ 08.09 | MVP 완성 |
| 4주차 | 08.10 ~ 08.16 | 통합 안정화·부하 검증·발표 자료 정리 |
