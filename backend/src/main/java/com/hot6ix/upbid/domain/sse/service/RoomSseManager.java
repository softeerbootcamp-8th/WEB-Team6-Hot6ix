...
public class RoomSseManager {
     ...
     * 어긋나는지 보고 판단한다.
     *
     * <p>{@link RejectedExecutionException}은 이제 유한 풀·큐가 다 차서 나는 게 아니라
     * {@code sseExecutor}가 종료 중일 때만 난다. 그래도 못 보낸 emitter만 실패한 것이라
     * 나머지 emitter 전송은 그대로 진행하고, {@code upbid.sse.broadcast.rejected}로 세고
     * 로그만 남긴다.
     *
