...
/**
 * 진행중인 물품에 입찰한다. 접수되면 물품의 현재가와 최고 입찰자가 함께 갱신된다. 최소 입찰 금액은 입찰이 아직 없으면 시작가, 있으면 현재가 + 입찰 단위다. 시작가와 같은 금액으로 첫 입찰을 할 수 있다. 금액은 (금액 - 시작가)가 입찰 단위의 배수여야 하며, 여러 단위를 한 번에 올릴 수 있다. 이미 최고 입찰자인 회원은 다시 입찰할 수 없다. 로그인 세션의 회원으로 입찰한다.
 * @summary 입찰 등록
 */
export const place = (
